    ...
    >
      ...
      <div class="hero-inner">
        <div class="container text-center hero-text font-white">
          <h1>Order & We Deliver</h1>
          <h5 class="font-white space-xs">
            Get Dishes & Specials With Bistel Eats.
          </h5>
          ...
          <div class="steps">
            ...
            <div class="step-item step3">
              ...
              <h4><span>3. </span>Make Payment</h4>
            </div>
            <!-- end:Step -->
          </div>
          <!-- end:Steps -->
...
export default {
  ...
  mounted () {
    this.$store.dispatch('cget')
    // console.log(this.$store.state.topRated1);
},
