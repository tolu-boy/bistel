<template>
  ...
  >
    ...
    >
      ...
      <div class="hero-inner">
        <div class="container text-center hero-text font-white">
          ...
          <h5 class="font-white space-xs">
            Get Dishes & Specials With Bistel Delivery.
          </h5>
          <div class="banner-form">
            <form class="form-inline">
              <div class="form-group">
                <label class="sr-only" for="exampleInputAmount"
                  >I would like to eat....</label
                >
                <div class="form-group">
                  <input
                    type="text"
    ...
    <div class="location-match text-xs-center">
      <div class="container">
        <span
          >35 restaurants matched your location:
          <span class="primary-color">lagos, Nigeria -</span>
        </span>
      </div>
    </div>
          ...
          <div class="row how-it-works-solution">
            ...
            >
              <div class="how-it-works-wrap">
                <div class="step step-1">
                  ...
                  <p>
                    We"ve got your covered with menus from over 345 delivery
                    restaurants online.
                  </p>
                </div>
              </div>
            ...
            >
              <div class="step step-3">
                ...
                <p>
                  Get your food delivered! And enjoy your meal! Pay online on
                  pickup or delivery
                </p>
              </div>
            </div>
      ...
      <div class="container">
          ...
          <div class="col-sm-8">
            ...
            <div class="restaurants-filter pull-right">
              <nav class="primary pull-left">
                <ul>
                  <li>
                    <a href="#" class="selected" data-filter="*">Grill</a>
                  </li>
        ...
        <div class="row">
          <div class="restaurant-listing">
            <div
              class="col-xs-12 col-sm-12 col-md-6 single-restaurant grill fish thaifood pizza"
            >
              <div class="restaurant-wrap">
                <div class="row">
                  <div
                    class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center"
                  >
                    <a class="restaurant-logo" href="#">
                      <img
                        src="@/assets/images/big-logo7.jpg"
                        alt="Restaurant logo"
                      />
                    </a>
                  </div>
                  ...
                  <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                    <h5><a href="profile.html">Maenaam Thai Restaurant</a></h5>
                    ...
                    <div class="bottom-part">
                      ...
                      <div class="mins">
                        <i class="fa fa-motorcycle"></i> 30 min
                      </div>
                      <div class="ratings">
                        <span>
            ...
            <!--end: col -->
            <div
              class="col-xs-12 col-sm-12 col-md-6 single-restaurant grill fish pasta thaifood"
            >
              <div class="restaurant-wrap">
                <div class="row">
                  <div
                  ...
                  >
                    <a class="restaurant-logo" href="#">
                      <img
                        src="@/assets/images/logo-plate.png"
                        alt="Restaurant logo"
                      />
                    </a>
                  </div>
            ...
            <!--end: col -->
            <div
              class="col-xs-12 col-sm-12 col-md-6 single-restaurant grill thaifood pasta pizza"
            >
              <div class="restaurant-wrap">
                <div class="row">
                  <div
                  ...
                  >
                    <a class="restaurant-logo" href="#">
                      <img
                        src="@/assets/images/big-logo8.png"
                        alt="Restaurant logo"
                      />
                    </a>
                  </div>
            ...
            <!--end: col -->
            <div
              class="col-xs-12 col-sm-12 col-md-6 single-restaurant thaifood fish pasta"
            >
              <div class="restaurant-wrap">
                <div class="row">
                  <div
                  ...
                  >
                    <a class="restaurant-logo" href="#">
                      <img
                        src="@/assets/images/big-logo4.png"
                        alt="Restaurant logo"
                      />
                    </a>
                  </div>
            ...
            <!--end: col -->
            <div
              class="col-xs-12 col-sm-12 col-md-6 single-restaurant grill fish thaifood pasta pizza"
            >
              <div class="restaurant-wrap">
                <div class="row">
                  <div
                  ...
                  >
                    <a class="restaurant-logo" href="#">
                      <img
                        src="@/assets/images/big-logo3.png"
                        alt="Restaurant logo"
                      />
                    </a>
                  </div>
            ...
            <!--end: col -->
            <div
              class="col-xs-12 col-sm-12 col-md-6 single-restaurant grill pasta pizza"
            >
              <div class="restaurant-wrap">
                <div class="row">
                  <div
                  ...
                  >
                    <a class="restaurant-logo" href="#">
                      <img
                        src="@/assets/images/big-logo2.png"
                        alt="Restaurant logo"
                      />
                    </a>
                  </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-5 join-text">
                <p>
                  Join the thousands of other restaurants who benefit from
                  having their menus on
                  <a href="#"><strong> FoodPicky directory</strong></a>
                </p>
              </div>
              <div class="col-xs-12 col-sm-4 join-btn text-xs-right">
                <a href="#" class="btn theme-btn btn-lg">I‘m restaurant</a>
              </div>
            </div>
          </div>
        </section>
