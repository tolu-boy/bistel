                ...
                >
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-lg-8">
                      <div class="rest-logo pull-left">
                        <a class="restaurant-logo pull-left" href="#"
                          ><img :src="items.url" alt="Food logo"
                        /></a>
                      </div>
                      <!-- end:Logo -->
                      <div class="rest-descr">
                        ...
                        class="btn btn-small btn btn-secondary "
                        data-toggle="modal"
                    ...
                    >
                      ...
                      <span class="price pull-left"> Price :{{ items.price }}</span>
                      ...
                      <span class="price pull-left"> Quantity :{{ items.quantity }}</span>
